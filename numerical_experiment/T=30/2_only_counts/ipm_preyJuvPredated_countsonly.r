...
# F. Barraquand 17/08/2018: removed CMR + repro to leave only counts
...
countsP = jags.data.out$countsP
countsV = jags.data.out$countsV
jags.data <- list(nyears = length(countsP), countsP = countsP, countsV = countsV)
